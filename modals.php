    ...
    <div class='flex flex-col'>
        <div class='flex flex-1  flex-col md:flex-row lg:flex-row mx-2'>
            ...
            <div class="mb-2 mx-2 border-solid border-gray-300 rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
                ...
                <div class="p-3">
                    <button data-modal='centeredModal' class="modal-trigger bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        Open modal
                    </button>
                </div>
        ...
        <div class='flex flex-1  flex-col md:flex-row lg:flex-row mx-2'>
            ...
            <div class="mb-2 mx-2 border-solid border-gray-300  rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
                ...
                <div class="p-3">
                    <button data-modal='largeSizeModal' class="modal-trigger bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        Open modal
                    </button>
                </div>
