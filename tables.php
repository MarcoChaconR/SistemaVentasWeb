            ...
            <div class="mb-2 border-solid border-grey-light rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
                ...
                <div class="p-3">
                    <table class="table-fixed">
                        <thead>
                            <tr>
                                <th class="border w-1/2 px-4 py-2">Titulo</th>
                                <th class="border w-1/4 px-4 py-2">Authr</th>
                                <th class="border w-1/4 px-4 py-2">Vistas</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
            ...
            <div class="mb-2 md:mx-2 lg:mx-2 border-solid border-gray-200 rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
                ...
                <div class="p-3">
                    <table class="table-fixed">
                        <thead>
                            <tr>
                                <th class="border-b bg-black text-white w-1/2 px-4 py-2">Titulo</th>
                                <th class="border-b bg-black text-white w-1/4 px-4 py-2">Authr</th>
                                <th class="border-b bg-black text-white w-1/4 px-4 py-2">Vistas</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
            ...
            <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                ...
                <div class="p-3">
                    <table class="table-responsive w-full rounded">
                        <thead>
                            <tr>
                                <th class="border w-1/4 px-4 py-2">Nombre Cliente</th>
                                <th class="border w-1/6 px-4 py-2">Ciudad</th>
                                <th class="border w-1/6 px-4 py-2">Producto</th>
                                <th class="border w-1/6 px-4 py-2">Total</th>
                                <th class="border w-1/7 px-4 py-2">Estado</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="border px-4 py-2">San José</td>
